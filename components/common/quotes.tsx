    ...
    <Wrapper className="py-20">
      <div className=" relative bg-[#131313] rounded-md border border-dashed border-neutral-700 px-4 py-10">
        <svg
          ...
          width="105"
          height="78"
          className="absolute top-6 left-6 fill-white/20"
        >
        ...
        <p className="dark:text-dark-white-300 relative z-10 font-mono font-medium text-pretty text-zinc-400 italic">
          “{quote}”
        </p>
